            ...
            it('should add an item on POST', function () {
                    ...
                    return chai.request(app)
                        ...
                        .then(function (res) {
                                ...
                                res.body.should.equal(Object.assign(newRecipe.name); res.body.ingredients.should.be.a('array'); res.body.ingredients.should.include.members(newRecipe.ingredients);
                                });
                        });
